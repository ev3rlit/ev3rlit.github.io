...
const phases: Phase[] = [
	...
	},
	{
		number: 4,
		period: "2025 — 현재",
		title: "Node.js 백엔드 전환",
		capability: "기술 전환",
		color: "text-stone-500 dark:text-stone-400",
		dotColor: "bg-stone-400 border-stone-400",
		borderColor: "hover:border-stone-400",
		highlights: [
			"NestJS 핵심 개념(Module, Controller, Service, DI) 학습 — 직접 설계한 구조와 동일 패턴 확인",
			"TypeORM + MySQL 학습 — BladeX Stored Procedure 경험 기반 관계형 DB 설계 역량 전환",
			"게임 서버 설계 역량을 Node.js 생태계로 확장 — REST API, 미들웨어, 에러 핸들링",
		],
	},
];
...
const appealPoints: AppealPoint[] = [
	...
	},
	{
		title: "자기 인식",
		description:
			"부족한 영역을 명확히 인식하고, Node.js 백엔드로의 전환을 체계적으로 준비하는 태도",
	},
];

// --- Component ---

export const SwissGrowthCurveSection_BackendGameduo = () => {
