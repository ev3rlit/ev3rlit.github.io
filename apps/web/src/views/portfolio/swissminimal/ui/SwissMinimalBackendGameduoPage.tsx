    ...
    return (
        <div className="relative h-full w-full overflow-hidden bg-white dark:bg-stone-950">
            ...
            >
                ...
                <div id="resume">
                    <SwissResumeSection
                        summary="Golang·C++ 기반 게임 서버를 설계하고, 6개월 만에 상용 서비스를 런칭하여 21개월 안정적인 라이브 운영을 주도한 3년차 백엔드 개발자입니다. 실시간 처리, 동시성 제어, 무중단 마이그레이션 같은 문제를 풀며 서비스 안정성의 가치를 체감했고, 이 경험을 Node.js/NestJS 기반 게임 백엔드로 확장하며, 로깅·모니터링 기반 시스템을 실제 인프라에 연동하여 운영하는 영역까지 성장하고 싶습니다."
                    />
                </div>
