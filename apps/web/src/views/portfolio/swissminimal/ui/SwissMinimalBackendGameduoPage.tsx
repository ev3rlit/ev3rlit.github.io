    ...
    return (
        <div className="relative h-full w-full overflow-hidden bg-white dark:bg-stone-950">
            ...
            >
                ...
                <div id="resume">
                    <SwissResumeSection
                        summary="Golang·C++ 기반 게임 서버를 설계하고, 런칭부터 글로벌 라이브 운영까지 전 사이클을 주도한 3년차 백엔드 개발자입니다. 실시간 처리, 동시성 제어, 무중단 마이그레이션 같은 문제를 풀며 서비스 안정성의 가치를 체감했고, 이 경험을 Node.js/NestJS 기반 게임 백엔드로 확장하여 라이브 서비스의 품질과 개발 생산성을 함께 높이고 싶습니다."
                    />
                </div>
